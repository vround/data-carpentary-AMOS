...
def create_plot(clim, model_name, season, gridlines=False, levels=None):
    """Plot the precipitation climatology, test script.
...
if __name__ == '__main__':
    ...
    parser.add_argument("cbar-ticks", type=list, help="Tick marks for colour bar")
    parser.add_argument("--gridlines", action="store_true", default=False, help="show gridlines")
